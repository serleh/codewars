...
//  a list of its multiples up to another value, limit . If limit is a multiple of integer, 
...
function multiplesOfNumber(integer, limit){
 ...
 console.log(multiplesOfNumber(5,25))